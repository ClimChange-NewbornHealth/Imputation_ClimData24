...
series <- rio::import(paste0(data_out, "series_full_2000_2023", ".RData")) |> 
  ...
  relocate(year, month, day, hour, .after=datetime)


#pm25 <- rio::import(paste0(data_out, "series_pm25_2000_2023", ".RData"))
#o3 <- rio::import(paste0(data_out, "series_o3_2000_2023", ".RData"))
#hum <- rio::import(paste0(data_out, "series_hum_2000_2023", ".RData"))
#pm10 <- rio::import(paste0(data_out, "series_pm10_2000_2023", ".RData"))
#temp <- rio::import(paste0(data_out, "series_temp_2000_2023", ".RData"))
#wspd <- rio::import(paste0(data_out, "series_wspd_2000_2023", ".RData"))
